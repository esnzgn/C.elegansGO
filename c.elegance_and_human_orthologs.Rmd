...
```{r load-worm}
file_path_worm <- "./06-2024/List of verified genes.xlsx" # Table 1 of the manuscript is inside the file 
# "List of verified genes.xlsx" as input of the enrichment analysis here
