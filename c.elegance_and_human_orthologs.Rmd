...
```{r load-worm}
file_path_worm <- "./06-2024/List of verified genes.xlsx" # Table 1 of the manuscript is inside the file "List of verified genes.xlsx" as input of the enrichment analysis here
...
# dotplot_2nd #One can find the final output of dotplot in manscript figure 2 panel a 
```
...
# dotplotCC_2nd # dotplot_2nd #One can find the final output of dotplot in manscript figure 2 panel b
